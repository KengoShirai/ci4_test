...
RUN yum -y install --enablerepo=epel,remi,remi-safe,remi-php72 php php-common php-opcache php-mbstring php-xdebug php-mysql php-mysqlnd php-zip php-pdo php-cli
